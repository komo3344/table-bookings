...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('web', '0010_alter_userprofile_nickname_review_booking_review'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='restaurant',
            name='category',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='web.category', verbose_name='카테고리'),
